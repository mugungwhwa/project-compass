...
const dictionary = {
  ...
  "settings.title":                   { ko: "어떤 데이터를 연결할 것인가?", en: "Which Data Sources to Connect?" },
  "settings.subtitle":                { ko: "계정 연동",                   en: "Integrations" },
  "settings.status.connected":        { ko: "연결됨",                      en: "Connected" },
  "settings.status.verifying":        { ko: "검증중",                      en: "Verifying" },
  "settings.status.error":            { ko: "오류",                        en: "Error" },
  "settings.status.disconnected":     { ko: "미연결",                      en: "Not connected" },
  "settings.comingSoon":              { ko: "준비중입니다",                 en: "Coming soon" },
  "settings.category.mmp":           { ko: "MMP (어트리뷰션)",            en: "MMP (Attribution)" },
  "settings.category.ab":            { ko: "A/B 테스트",                  en: "A/B Testing" },
  "settings.lastSync":               { ko: "마지막 동기화",                en: "Last sync" },
  "settings.action.connect":         { ko: "연결하기",                    en: "Connect" },
  "settings.action.reconnect":       { ko: "재연결",                      en: "Reconnect" },
  "settings.action.manage":          { ko: "설정",                        en: "Manage" },
  "settings.hint.mmp":               { ko: "MMP를 연결하면 코호트 리텐션이 시장 벤치마크와 비교되어 투자 신호가 생성됩니다",
                                        en: "Connect an MMP to compare cohort retention against market benchmarks and generate investment signals" },
  "settings.hint.ab":                { ko: "A/B 테스트 플랫폼을 연결하면 실험 결과가 ΔLTV → 투자 가치로 자동 번역됩니다",
                                        en: "Connect an A/B platform to automatically translate experiment results into ΔLTV → investment value" },
  "settings.category.manual":        { ko: "수동 입력",                    en: "Manual Input" },
  "settings.hint.manual":            { ko: "MMP나 실험 플랫폼이 없어도 CSV 또는 직접 입력으로 Compass를 사용할 수 있습니다",
                                        en: "Use Compass without an MMP or experiment platform via CSV or direct input" },
  "settings.category.financial":     { ko: "재무 데이터 (Silo 4)",         en: "Financial Data (Silo 4)" },
  "settings.hint.financial":         { ko: "재무 정보를 입력하면 페이백 기간, 번 레이트, 투자 여력이 계산됩니다. 모든 데이터는 AES-256 암호화됩니다",
                                        en: "Enter financials to calculate payback period, burn rate, and investment capacity. All data is AES-256 encrypted" },
  "settings.security.encrypted":     { ko: "암호화 저장",                  en: "Encrypted" },
  "settings.financial.monthlyRevenue":    { ko: "월 매출",                 en: "Monthly Revenue" },
  "settings.financial.uaSpend":           { ko: "월 UA 비용",              en: "Monthly UA Spend" },
  "settings.financial.cashBalance":       { ko: "현금 잔액",               en: "Cash Balance" },
  "settings.financial.monthlyBurn":       { ko: "월간 총 지출",            en: "Monthly Burn" },
  "settings.financial.targetPayback":     { ko: "목표 페이백",             en: "Target Payback" },
  "settings.financial.targetPaybackUnit": { ko: "일",                      en: "days" },
  "settings.financial.placeholder":       { ko: "예: $100K 또는 $100K-$200K", en: "e.g. $100K or $100K-$200K" },
  "settings.financial.save":              { ko: "저장",                    en: "Save" },
  "settings.financial.saved":             { ko: "저장되었습니다",           en: "Saved" },

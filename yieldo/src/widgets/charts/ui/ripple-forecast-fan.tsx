    ...
    >
      ...
      <ResponsiveContainer width="100%" height={chartHeight}>
        <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
          ...
          <Area type="linear" dataKey="p10" stroke="none" fill="#0E1320" /* mask = bg-1 dark; cuts lower band on terminal canvas */ animationBegin={200} animationDuration={1200} animationEasing="ease-out" />

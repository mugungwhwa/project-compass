...
**Compass의 베이지안 Prior 구축에 가장 중요한 소스.** 인터벤션 효과를 시장 벤치마크 대비 평가하는 기준선을 제공한다.
...
```
Tier 1 (MVP, 수동 입력 3분):
  → Compass 대시보드 Settings > Financial 페이지
  → 5개 필드만 입력
...
> **Compass에서 가장 전략적으로 중요한 데이터 소스.** 실험 ATE(Average Treatment Effect)를

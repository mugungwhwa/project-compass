...
**중요**: 이 섹션은 2026-04-14 초안에서 "Compass = Alpha 측정 인프라"라는 top-line 포지션을 제안했으나, 2026-04-15 brainstorming 세션에서 외부 검증 없이 단독 합의된 리스크를 식별하고 재조정함. 상세는 `2026-04-15-compass-positioning-language-layering-design.md`.
...
Market Gap 페이지의 L1은 "장르 기대치 vs 우리 실적" 언어로 통일, Alpha 단어 미노출. L2 methodology 패널에서만 Alpha 용어 허용. 상세 spec: `2026-04-14-market-gap-bayesian-p3-implementation.md` §3.1 (재조정판), `2026-04-15-compass-positioning-language-layering-design.md` §4.
